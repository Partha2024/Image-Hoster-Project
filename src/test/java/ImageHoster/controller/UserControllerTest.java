...
public class UserControllerTest {
    ...
    //This test checks the controller logic for user signup when user requests for a registration form'
    @Test
    ...
    //This test checks the controller logic for user signup when user fills the form and send the POST request to the server but the password type is wrong
    @Test
    ...
    //This test checks the controller logic for user signup when user fills the form and send the POST request to the server with the correct password type
    @Test
    ...
    //This test checks the controller logic for user signin when user enters the username and password that has not been registered and sends the POST request to the server
    @Test
    ...
    //This test checks the controller logic for user signin when user enters the username and password that has been registered and sends the POST request to the server
    ...
    //This test checks the controller logic for user signout where he sends the POST request to the server to invalidate the session
    @Test
