...
public class ImageControllerTest {
    ...
    //This test checks the controller logic to get all the images after the user is logged in the application and checks whether the logic returns
    @Test
    ...
    //This test checks the controller logic when the logged in user sends the GET request to the server to get the details of a particular image
    @Test
    ...
    //This test checks the controller logic when the logged in user sends a GET request to the server to get the form to upload an image in the application
    @Test
    ...
    //This test checks the controller logic when the logged in submits the image to be uploaded in the application
    @Test
